...
<div class="container">
    ...
    <p>
    You must be at least 18 years and the age of majority in your state of residence, and you must register for an account (<strong>Account</strong>) to use the Service.
    ...
    <p>
    We reserve the right, at our discretion, to change or modify these Terms at any time. Although it is your responsibility to review these Terms from time to time for any changes, we will notify you of any revisions to these Terms by posting them at this location. If you do not agree to the revised Terms, you must stop using our Service. Your continued use of our Service following any revision to these Terms signifies your assent to and acceptance of the revised Terms.
    </p>

    <p>
    You agree that we retain the unfettered right to modify any aspect of the Service. You acknowledge that we have been, is, and will be constantly making changes to the Service. These changes include modifications to features, functions or abilities of any element of the Service.
    </p>
    ...
    <h5>Gift Items Not Eligible for Refund</h5>
    ...
    The amount to be refunded is the face value price of the gift item on the time it was purchased. But Service fees and 3rd party payment processor fees will be non-refundable. 

    The mode of payment for the refund will be done electronically through online bank services or other electronic payment methods. 
    </p>
    ...
    <p>
    NEITHER BEAM GIFTS, ITS AFFILIATES, LICENSORS AND THIRD-PARTY PROVIDERS, NOR ANY OF THEIR RESPECTIVE DIRECTORS, OFFICERS, EMPLOYEES OR AGENTS (COLLECTIVELY, THE "BEAM TEAM PARTIES"), MAKE ANY WARRANTY WHATSOEVER, INCLUDING, WITHOUT LIMITATION, THAT THE SERVICE WILL BE UNINTERRUPTED OR ERROR FREE; NOR DO THEY MAKE ANY WARRANTY AS TO THE RESULTS THAT MAY BE OBTAINED FROM USE OF THE SERVICE,
    ...
    YOU EXPRESSLY AGREE THAT YOUR USE OF, OR INABILITY TO USE, THE SERVICE IS AT YOUR SOLE RISK. THE SERVICE AND ANY CONTENT APPEARING ON THE SERVICE ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. WITHOUT LIMITING THE FOREGOING, TO THE FULLEST EXTENT PERMITTED BY LAW, BEAM GIFTS MAKES NO REPRESENTATIONS, WARRANTIES, CONDITIONS OR OTHER TERMS OF ANY KIND, EITHER EXPRESS OR IMPLIED, ABOUT THE SERVICE. BEAM GIFTS DISCLAIMS ANY WARRANTIES OF TITLE OR IMPLIED WARRANTIES, CONDITIONS OR OTHER TERMS OF NON-INFRINGEMENT, MERCHANTABILITY, QUIET ENJOYMENT OR FITNESS FOR A PARTICULAR PURPOSE, OTHER THAN THOSE WARRANTIES WHICH ARE INCAPABLE OF EXCLUSION, RESTRICTION OR MODIFICATION UNDER THE LAWS APPLICABLE TO THESE TERMS.
    </p>

    <h5>LIMITATION OF LIABILITY</h5>

    <p>
    IN NO EVENT WILL ANY OF THE BEAM TEAM PARTIES BE LIABLE FOR ANY INDIRECT, SPECIAL, PUNITIVE, INCIDENTAL, OR CONSEQUENTIAL DAMAGES HOWEVER CAUSED, AND UNDER ANY THEORY OF LIABILITY EVEN IF BEAM GIFTS WAS PREVIOUSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.

    IN THE EVENT ANY CLAIM RELATING TO THE PERFORMANCE OR NONPERFORMANCE BY BEAM GIFTS PURSUANT TO THESE TERMS, OR IN ANY OTHER WAY CONCERNING THE SERVICE IS MADE BY YOU, THE ACTUAL DAMAGES TO WHICH YOU MAY BE ENTITLED SHALL BE LIMITED TO A REFUND OF THE GIFT ITEM PRICE AMOUNT, IF ANY, PAID BY YOU AND RECEIVED BY BEAM GIFTS FOR USE OF THE SERVICE IN THE 3 MONTH PERIOD PRECEDING YOUR CLAIM AND IF YOU HAVE NOT PAID ANY AMOUNT DURING THAT TIME PERIOD, YOU ACKNOWLEDGE THAT YOUR SOLE REMEDY SHALL BE TO CEASE USING THE SERVICE.

    SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF STATUTORY OR IMPLIED WARRANTIES, OR THE EXCLUSION OR LIMITATION OF LIABILITY FOR CERTAIN TYPES OF DAMAGES. IN SUCH JURISDICTIONS THE LIMITATIONS AND EXCLUSIONS SET FORTH HEREIN MAY NOT APPLY TO YOU. CONSEQUENTLY, IN SUCH JURISDICTIONS, THE LIABILITY OF THE BEAM TEAM PARTIES IS LIMITED TO THE EXTENT PERMITTED BY LAW, THEREBY MINIMIZING THE LIABILITY OF SUCH BEAM TEAM PARTIES TO YOU TO THE LOWEST AMOUNT PERMITTED BY APPLICABLE LAW. THIS LIMITATION IS INDEPENDENT OF ANY OTHER LIMITATION SET FORTH IN THESE TERMS.

    THE BEAM TEAM PARTIES DO NOT ENDORSE AND ARE NOT RESPONSIBLE FOR THE ACCURACY OR RELIABILITY OF ANY OPINION, ADVICE OR STATEMENT, NOR FOR ANY OFFENSIVE, DEFAMATORY, OBSCENE OR ILLEGAL POSTING OR CONDUCT, ON THE SERVICE, INCLUDING, WITHOUT LIMITATION, BY ANYONE OTHER THAN AUTHORIZED BEAM TEAM EMPLOYEES WHILE ACTING IN THEIR OFFICIAL CAPACITIES.
    </p>
    ...
    <p>
    The laws of the Philippines govern the interpretation of these Terms and apply to claims for breach of these Terms, regardless of conflict of laws principles. The parties specifically exclude from application to these Terms the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transactions Act. All other claims, including claims regarding consumer protection laws, unfair competition laws, and in tort, will, only to the extent required by applicable law, be subject to the laws of the country in which you reside. You and we irrevocably consent to the exclusive jurisdiction and venue of Iloilo city court, Philippines, for all disputes arising out of or relating to these Terms. Any claim or cause of action arising out of or related to use of the Service or these Terms must be filed within 1 year after such claim or cause or action arose regardless of any statutes or law to the contrary. In the event any such claim or cause of action is not filed within such a 1 year period, such claim or cause of action are forever barred.
    For any claim (excluding claims for injunctive or other equitable relief) where the total amount of the award sought is less than Php 100,000.00, the party requesting relief shall resolve the dispute in a cost-effective manner through binding non-appearance-based arbitration. The party requesting relief shall initiate such arbitration through an established alternative dispute resolution (ADR) provider mutually agreed upon by the parties. The ADR provider and the parties must comply with the following rules: (a) the arbitration shall be conducted by telephone, online and/or be solely based on written submissions, and the specific manner shall be chosen by the party initiating the arbitration; all aspects of the arbitration shall be conducted in the English language; (c) the arbitration shall not involve any personal appearance by the parties or witnesses unless otherwise mutually agreed by the parties; and (d) any judgment on the award rendered by the arbitrator shall be final and may be entered in any court of competent jurisdiction.
    All claims you bring against Beam Gifts must be resolved in accordance with this Section. All claims filed or brought contrary to this Section shall be considered improperly filed. Should you file a claim contrary to this Section, Beam Gifts shall be entitled to recover attorneys' fees and costs up to Php 100,000.00, provided that Beam Gifts has notified you in writing of the improperly filed claim, and you have failed to promptly withdraw the claim.
    </p>
    ...
    <h5>Enforceability, Entire Agreement & Non-Waiver</h5>
    <p>
    These Terms are deemed accepted upon any use of the Service. These Terms and any additional terms referenced herein constitute the entire agreement between you and Beam Gifts regarding the use of the Service. Our failure to exercise or enforce any right or provision of these Terms shall not operate as a waiver of such right or provision. The section titles in these Terms are for convenience only and have no legal or contractual effect.
    </p>
    ...
    Subject to the other provisions of these Terms, we will attempt to help you with any queries or problems that you may have with the Service and any questions about these Terms generally. To reach our support team, please email us at support@beam.gifts.
    </p>
