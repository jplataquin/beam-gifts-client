                        ...
                        <ul class="dnavs">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="button pl-3 pr-3 nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                        {{ Auth::user()->nickname() }}
                                    </a>
